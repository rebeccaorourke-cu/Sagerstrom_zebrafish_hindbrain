---
title: "HB16hpf r1, r2, r3 vgll3 & egr2b expression R Notebook"
...
## 3.1 HB.1
```{r hb1subset, echo=FALSE}
HB.1cells <- subset(HB10hpf, idents = "HB.1", features = c("vgll3","egr2b"))
df.HB1 <- as.data.frame(t(GetAssayData(HB.1cells, slot = "data", assay = "SCT")))

HB1.vgll3 <- sum(df.HB1$vgll3 > 0 & df.HB1$egr2b == 0) 
HB1.egr2b <- sum(df.HB1$vgll3 == 0 & df.HB1$egr2b > 0) 
HB1.vgll3.egr2b <- sum(df.HB1$vgll3 > 0 & df.HB1$egr2b > 0) 
HB1.none <- sum(df.HB1$vgll3 == 0 & df.HB1$egr2b == 0)
...
vgll3.egr2b <- c("+/-","-/+","+/+","-/-")
count <- c(HB1.vgll3,HB1.egr2b,HB1.vgll3.egr2b,HB1.none)
#data4 <- data.frame(rhombomere,condition,count)
data4 <- data.frame(rhombomere,vgll3.egr2b,count)
data4
```
...
r1cells.13 <- subset(HB13hpf, idents = "r1", features = c("vgll3","egr2b"))
df.r1.13 <- as.data.frame(t(GetAssayData(r1cells.13, slot = "data", assay = "SCT")))

r1.vgll3.13 <- sum(df.r1.13$vgll3 > 0 & df.r1.13$egr2b == 0) 
r1.egr2b.13 <- sum(df.r1.13$vgll3 == 0 & df.r1.13$egr2b > 0) 
r1.vgll3.egr2b.13 <- sum(df.r1.13$vgll3 > 0 & df.r1.13$egr2b > 0) 
r1.none.13 <- sum(df.r1.13$vgll3 == 0 & df.r1.13$egr2b == 0)
...
r2cells.13 <- subset(HB13hpf, idents = "r2", features = c("vgll3","egr2b"))
df.r2.13 <- as.data.frame(t(GetAssayData(r2cells.13, slot = "data", assay = "SCT")))

r2.vgll3.13 <- sum(df.r2.13$vgll3 > 0 & df.r2.13$egr2b == 0) 
r2.egr2b.13 <- sum(df.r2.13$vgll3 == 0 & df.r2.13$egr2b > 0) 
r2.vgll3.egr2b.13 <- sum(df.r2.13$vgll3 > 0 & df.r2.13$egr2b > 0) 
r2.none.13 <- sum(df.r2.13$vgll3 == 0 & df.r2.13$egr2b == 0)
...
r3cells.13 <- subset(HB13hpf, idents = "r3", features = c("vgll3","egr2b"))
df.r3.13 <- as.data.frame(t(GetAssayData(r3cells.13, slot = "data", assay = "SCT")))

r3.vgll3.13 <- sum(df.r3.13$vgll3 > 0 & df.r3.13$egr2b == 0) 
r3.egr2b.13 <- sum(df.r3.13$vgll3 == 0 & df.r3.13$egr2b > 0) 
r3.vgll3.egr2b.13 <- sum(df.r3.13$vgll3 > 0 & df.r3.13$egr2b > 0) 
r3.none.13 <- sum(df.r3.13$vgll3 == 0 & df.r3.13$egr2b == 0)
