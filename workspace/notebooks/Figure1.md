...
![](Figure1_files/figure-gfm/readData-1.png)<!-- -->
...
![](Figure1_files/figure-gfm/RenameIdents-1.png)<!-- -->
...
```
    ...
    ## Calculating cluster MHB.4

    ## Calculating cluster SC.2

    ## Calculating cluster MB.3

    ## Calculating cluster FB.2

    ## Calculating cluster r1 & r2

    ## Calculating cluster Ciliated

    ## Calculating cluster FB.3

    ## Calculating cluster FB.4

    ## Calculating cluster MHB.5
...
```
    ...
    ##  1 7.33e-36      2.57  0.843 0.201  1.34e-31 CaudHB.1 adgrl1a  
    ##  2 2.48e-27      1.07  0.549 0.082  4.53e-23 CaudHB.1 arhgef28a
    ##  3 1.40e-21      0.953 0.843 0.256  2.56e-17 CaudHB.1 zic2b    
    ##  4 8.40e-21      1.33  0.627 0.152  1.54e-16 CaudHB.1 msx1b    
    ##  5 3.41e-20      0.731 0.49  0.086  6.25e-16 CaudHB.1 rorcb    
    ##  6 2.20e-71      1.91  0.894 0.066  4.04e-67 r3       egr2b    
    ##  7 3.38e-59      2.45  0.83  0.079  6.19e-55 r3       timp2b   
    ##  8 5.75e-48      1.35  0.66  0.054  1.05e-43 r3       egr2a    
    ##  9 2.54e-47      1.42  0.66  0.056  4.65e-43 r3       myo1cb   
    ## 10 4.97e-37      1.94  0.894 0.187  9.10e-33 r3       sema3fb  
    ## # … with 125 more rows
...
![](Figure1_files/figure-gfm/dotplot-1.png)<!-- -->
...
![](Figure1_files/figure-gfm/heatmap-1.png)<!-- -->
