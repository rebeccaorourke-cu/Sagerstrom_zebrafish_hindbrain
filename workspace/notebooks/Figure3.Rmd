...
seurat <- RenameIdents(seurat,
                       ...
                       "22" = "FB & eye.7",
                       "23" = "FB & eye.8")
levels(seurat) <- c("SC.1","SC.2","SC.3","CHB.1","CHB.2","CHB.3","NC.1","NC.2","HB.1","HB.2","HB.3",
...
## 5.4 Gene Expression and violin plots
```{r, fig.width=7, fig.height=3}
#genes1 <- FeaturePlot(seurat, features = c("sox3","neurod4"), reduction = "wnn.umap", keep.scale = "all")  
#genes1
#ggsave(filename = "../results/Fig3_HB10hpf_genes1_scaledToMax.png", plot = genes1)
```
...
# genes2
# ggsave(filename = "../results/Fig3_HB10hpf_genes2_scaledToMax.png", plot = genes2)
```

```{r, fig.width=10, fig.height=10}
# genes2 <- FeaturePlot(seurat, features = genelist, reduction = "wnn.umap", max.cutoff = 1)  
# genes2
# ggsave(filename = "../results/Fig3_HB10hpf_genes2_scaledToMin.png", plot = genes2)
```

```{r, fig.width=15, fig.height=10}
# violinPlot <- VlnPlot(seurat, features = genelist, same.y.lims = TRUE)
# violinPlot
# ggsave(filename = "../results/Fig3_HB10hpf_violinPlot.png", plot = violinPlot)
```
