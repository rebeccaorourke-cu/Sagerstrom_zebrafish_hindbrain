...
```{r featureplot, fig.width=7, fig.height=3}
...
```{r getchromvarplots, fig.width=7, fig.height=5}
...
```{r getchromvarplots2, fig.width=7, fig.height=5}
...
```{r motifpluschromvar, fig.width=15, fig.height=15}
