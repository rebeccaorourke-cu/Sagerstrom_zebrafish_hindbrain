...
heatmapPlot
ggsave(filename = "../results/Fig5_HB16hpf_heatmapPlot.png", plot = heatmapPlot) ## heatmap included in Fig5 not Fig2
```
...
png(filename = "../results/Fig5_HB16hpf_clustertree_unrooted_vrs1.pdf")
