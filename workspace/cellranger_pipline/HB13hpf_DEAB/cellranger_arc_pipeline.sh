...
REF=cellranger_arc_genomes/zebrafishPlusGFP/GRCz11_with_chr

SAMPLES=(HB13hpf_DEAB)
SAMPLE=${SAMPLES[$(($LSB_JOBINDEX - 1))]}
ID=${SAMPLE}

cellranger-arc count --id=${ID} --reference=${REF} --libraries=library.csv --localmem 47 --localcores 40
